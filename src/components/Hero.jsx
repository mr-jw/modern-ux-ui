  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative w-full">
        <div className="mx-w-7x1 mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative">
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-12 animate-in slide-in-from-bottom duration-700 delay-300">
              ...
              <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:bg-white/10 flex items-center justify-center space-x-2">
                <div className="p-2 bg-white/10 rounded-full group-hover:bg-white/20 duration-300 transition-colours">
                ...
                <div className="p-3 sm:p-4 relative h-full">
                  ...
                  <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                    <button
                      ...
                      className={`px-3 py-2 backdrop-blur-small text-xs sm:text-sm rounded-t-lg border 
                    ${
                      activeTab === "App.jsx"
                  ...
                  <div className="relative overflow-hidden flex-grow">
                    {/* Wrapper component - something has to be inside of it. */}
                    <SyntaxHighlighter
                      language="javascript"
                      style={nightOwl}
                      customStyle={{
